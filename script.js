...
searchContainer.innerHTML = `
  <input type="text" id="searchBox" placeholder="Search students by name, programme, or year..." style="width: 100%; padding: 0.5em;">
`;
cards.parentNode.insertBefore(searchContainer, cards);
